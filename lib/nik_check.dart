...
class _NikCheckerPageState extends State<NikCheckerPage> with SingleTickerProviderStateMixin {
  ...
  final Color primaryPurple = const Color(0xFF6200EA); // Ungu Utama (Deep Purple)
  final Color accentPurple = const Color(0xFFAA00FF); // Ungu Aksen (Lebih Terang)
  final Color lightPurple = const Color(0xFFD500F9); // Ungu Highlight
  final Color primaryWhite = Colors.white;
  final Color accentGrey = Colors.grey.shade400;
  final Color cardDark = const Color(0xFF1E1B26); // Latar kartu dengan sedikit tint ungu
