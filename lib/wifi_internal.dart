...
class _WifiInternalPageState extends State<WifiInternalPage> {
  ...
  final Color accentPurple = const Color(0xFFAA00FF); // Diganti dari Red ke Purple
  final Color cardDark = const Color(0xFF1E1B26); // Sedikit tint ungu pada background kartu
  ...
  Future<void> _attackTarget() async {
    ...
    final url = Uri.parse(
        "http://zanzzstorecsmurmerpanel.lightsecret.my.id:2024/killWifi?key=${widget.sessionKey}&target=$publicIp&duration=120");
    try {
      ...
      builder: (_) => AlertDialog(
        ...
        actions: [
          TextButton(
            ...
            child: Text("OK", style: TextStyle(color: accentPurple)), // Ubah ke ungu
          ),
        ],
      ),
    );
              ...
              if (isVpn)
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: accentPurple), // Ubah border ke ungu
                  ),
                  child: Text(
                ...
                Center(
                  child: ElevatedButton.icon(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: accentPurple, // Ubah tombol ke ungu
