...
class _AdminPageState extends State<AdminPage> {
  ...
  Future<void> _fetchUsers() async {
    ...
    try {
      final res = await http.get(
        Uri.parse('http://zanzzstorecsmurmerpanel.lightsecret.my.id:2024/listUsers?key=$sessionKey'),
      );
  ...
  Future<void> _deleteUser() async {
    ...
    try {
      final res = await http.get(
        Uri.parse(
          'http://zanzzstorecsmurmerpanel.lightsecret.my.id:2024/deleteUser?key=$sessionKey&username=$username',
        ),
      );
      final data = jsonDecode(res.body);
  ...
  Future<void> _createAccount() async {
    ...
    try {
      ...
      final url = Uri.parse(
        'http://zanzzstorecsmurmerpanel.lightsecret.my.id:2024/userAdd?key=$sessionKey&username=$username&password=$password&day=$day&role=$newUserRole',
      );
          ...
          Center(
            child: Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(colors: [primarySilver, accentSilver]),
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          labelText: label,
          labelStyle: TextStyle(color: accentSilver),
          ...
          Row(
            children: [
              Container(
                ...
                child: Icon(icon, color: accentSilver),
              ),
              SizedBox(width: 12),
              Text(
                title,
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(Icons.person, color: accentSilver),
          ),
          SizedBox(width: 16),
          Expanded(
            child: Column(
              ...
              onPressed: () async {
                ...
                final confirm = await showDialog<bool>(
                  ...
                  builder: (_) => AlertDialog(
                    ...
                    title: Row(
                      children: [
                        Icon(Icons.info_outline, color: accentSilver),
                        const SizedBox(width: 10),
                        Text(
                          "Konfirmasi",
                          style: TextStyle(color: primaryWhite),
      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [bgDark, primarySilver.withOpacity(0.1), bgDark],
          ),
        ),
        child: SafeArea(
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                // Header
                Icon(Icons.admin_panel_settings, color: accentSilver, size: 50),
                SizedBox(height: 10),
                Text(
                  "ADMIN DASHBOARD",
                  style: TextStyle(
