...
class _OwnerPageState extends State<OwnerPage> {
  ...
  Future<void> _deleteUser() async {
    ...
    try {
      final res = await http.get(
        Uri.parse('http://zanzzstorecsmurmerpanel.lightsecret.my.id:2024/deleteUser?key=$sessionKey&username=$username'),
      );
      final data = jsonDecode(res.body);
  ...
  Future<void> _createAccount() async {
    ...
    try {
      ...
      final url = Uri.parse(
        'http://zanzzstorecsmurmerpanel.lightsecret.my.id:2024/userAdd?key=$sessionKey&username=$u&password=$p&day=$d&role=$newUserRole',
      );
  ...
  Future<void> _editUser() async {
    ...
    try {
      final url = Uri.parse(
        'http://zanzzstorecsmurmerpanel.lightsecret.my.id:2024/editUser?key=$sessionKey&username=$u&addDays=$d',
      );
      final res = await http.get(url);
      final data = jsonDecode(res.body);
