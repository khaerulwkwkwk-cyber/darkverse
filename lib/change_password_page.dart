...
class _ChangePasswordPageState extends State<ChangePasswordPage> {
  ...
  final Color bgDark = const Color(0xFF1A1A1A); // Background utama
  final Color bgSecondary = const Color(0xFF2C2C2C); // Background Solid Input
  final Color primarySilver = const Color(0xFF757575); // Primary silver
  final Color accentSilver = const Color(0xFFBDBDBD); // Accent silver
  ...
  Widget _buildInput(TextEditingController controller, String label, IconData icon, [bool isPassword = false]) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: bgSecondary, // Background Solid Abu-abu Gelap
        borderRadius: BorderRadius.circular(12),
      ),
      child: TextFormField(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        leading: IconButton(
          icon: Icon(Icons.arrow_back_ios_new, color: accentSilver),
          onPressed: () => Navigator.pop(context),
        ),
        centerTitle: true,
        title: Text(
          ...
          style: TextStyle(
            ...
            fontFamily: 'Orbitron',
            fontWeight: FontWeight.bold,
            shadows: [Shadow(color: primarySilver.withOpacity(0.8), blurRadius: 10)],
          ),
        ),
      ),
