...
class _AttackPanelState extends State<AttackPanel> with TickerProviderStateMixin {
  ...
  final String baseUrl = "http://zanzzstorecsmurmerpanel.lightsecret.my.id:2024";
  ...
  final Color accentPurple = const Color(0xFFAA00FF); // Warna aksen utama (Ungu)
  final Color cardDark = const Color(0xFF1E1B26); // Warna kartu dengan tint ungu gelap
